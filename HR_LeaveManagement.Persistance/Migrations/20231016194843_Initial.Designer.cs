...
namespace HR_LeaveManagement.Persistance.Migrations
{
    ...
    [Migration("20231016194843_Initial")]
            ...
            modelBuilder.Entity("HR_LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 10, 16, 12, 48, 43, 719, DateTimeKind.Local).AddTicks(8328),
                            DateModified = new DateTime(2023, 10, 16, 12, 48, 43, 719, DateTimeKind.Local).AddTicks(8370),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
